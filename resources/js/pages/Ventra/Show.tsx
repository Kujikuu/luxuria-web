...
export default function DealioShowPage({ slug }: DealioShowPageProps) {
    ...
    const fetchOpportunity = async () => {
        ...
        try {
            const response = await fetch(`/api/ventra/opportunities/${slug}`);
            ...
            fetch(`/api/ventra/opportunities/${slug}/view`, {
                method: 'POST',
                headers: {
            ...
            const similarResponse = await fetch(`/api/ventra/opportunities/${slug}/similar`);
        ...
        <AppLayout color="white" section="hero">
            ...
            <section id="hero" className="-mt-20 flex w-full max-w-6xl flex-col gap-10 px-4 pt-24 pb-24 sm:px-6 sm:pt-32 md:px-10 md:pt-52">
                <div className="flex justify-between items-center">
                    <div>
                        <NavLink href={getLocalizedPath('/ventra')} className="text-text-primary" arrow={true}>
                            {t('go_back') || 'Go Back'}
                        </NavLink>
                    </div>
