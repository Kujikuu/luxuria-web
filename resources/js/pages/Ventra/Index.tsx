...
export default function DealioIndexPage() {
    ...
    const fetchOptions = async () => {
        const [regionsResponse, typesResponse] = await Promise.all([fetch('/api/ventra/regions'), fetch('/api/ventra/types')]);
    ...
    const fetchOpportunities = async (
        ...
        try {
            ...
            const response = await fetch(`/api/ventra/opportunities?${params.toString()}`);
