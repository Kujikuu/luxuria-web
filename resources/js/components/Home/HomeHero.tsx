...
export default function HomeHero() {
    return (
        <section id="hero" className="flex flex-col relative pt-24 sm:pt-32 md:pt-52 -mt-20 bg-gradient-to-b from-primary from-55% to-primary/0 overflow-hidden w-full items-center justify-center">
            <div className="flex flex-col w-full relative gap-6 sm:gap-8 md:gap-10 justify-center items-center">
                ...
                <div className="flex flex-col relative items-center justify-center gap-4 sm:gap-5 md:gap-6 px-4 sm:px-6 md:px-10 w-full text-center">
                    <motion.div {...fadeInUp} transition={{ ...fadeInUp.transition, delay: 0.4 }}>
                        <Text variant="heading1" className="text-ui-1 max-w-[280px] sm:max-w-[400px] md:max-w-[700px]" >Crafting Luxury Life</Text>
                    </motion.div>
